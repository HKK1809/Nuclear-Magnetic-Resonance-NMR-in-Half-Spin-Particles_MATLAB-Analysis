...
legend('Spin-Spin Time Delay for Mineral Oil', 'T2 = (10 +/- 26)ms','FontSize',18)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MoilextractT2 = 'MoilT2extracted1527825.isf';
MoilextractT2 = isfread(MoilextractT2);
time_extracted = MoilextractT2.x;
voltage_extracted = MoilextractT2.y;
